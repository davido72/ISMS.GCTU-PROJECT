                ...
                <div class="card-header" style="justify-content: space-between; flex-wrap: wrap; gap: 10px;">
                    ...
                    <div>
                        <button class="btn btn-success" onclick="studentView.downloadResultsTranscript()">
                            <i class="fa-solid fa-file-pdf"></i> Download Official Statement of Results (PDF)
                        </button>
                    </div>
                </div>

                <div style="background: linear-gradient(135deg, rgba(16, 185, 129, 0.1), rgba(37, 99, 235, 0.1)); padding: 20px; border-radius: var(--radius-md); margin-bottom: 24px; display: flex; justify-content: space-between; align-items: center; flex-wrap: wrap; gap: 14px;">
                    <div>
                    ...
                    <div style="text-align: right;">
                        <span id="res-gpa-label" style="font-size: 0.8rem; text-transform: uppercase; color: var(--text-muted); font-weight: 700;">CUMULATIVE GPA</span>
                        <h2 id="res-gpa-display" style="font-size: 2.2rem; color: var(--status-success); margin: 0;">${gpa} / 4.00</h2>
                    </div>
                </div>
